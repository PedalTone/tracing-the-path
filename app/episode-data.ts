...
export const nodes: MapNode[] = [
  ...
  { id: "ampex", label: "Ampex videotape", kind: "object", image: "sketch-ampex-videotape.png", x: 88, y: 29, firstSeen: 0, historicalDate: "1944–1956", description: "Ampex turns magnetic recording into a practical broadcast system capable of carrying the Kitchen Debate to television." },
  ...
  { id: "pepsi", label: "Pepsi-Cola", kind: "object", image: "sketch-pepsi-cola.png", x: 31, y: 50, firstSeen: 0, historicalDate: "1893 onward", description: "A repeatedly reinvented soft drink becomes a consumer symbol, international wager, and barter currency." },
  ...
  { id: "nixon", label: "Richard Nixon", kind: "person", image: "sketch-richard-nixon.png", x: 12, y: 71, firstSeen: 0, historicalDate: "1959", description: "The U.S. vice president who guides Khrushchev to Pepsi and argues with him inside the model kitchen." },
  { id: "khrushchev", label: "Nikita Khrushchev", kind: "person", image: "sketch-nikita-khrushchev.png", x: 31, y: 71, firstSeen: 0, historicalDate: "1953–1964", description: "The Soviet leader who accepts the exhibition, samples Pepsi, and debates Nixon on camera." },
