...
export const nodes: MapNode[] = [
  { id: "empire", label: "U.S.–Russia trade", kind: "idea", image: "moscow-kremlin.jpg", x: 13, y: 13, firstSeen: 58, historicalDate: "1763–1917", description: "Commercial ties, ships, and American companies connect the two countries long before the Cold War." },
  { id: "lenin", label: "Vladimir Lenin", kind: "person", image: "vladimir-lenin.jpg", x: 37, y: 12, firstSeen: 300, historicalDate: "1917", description: "The Bolshevik revolution nationalizes industry and pushes foreign companies out." },
  { id: "newsreels", label: "Soviet newsreels", kind: "object", image: "newsreel-camera.jpg", x: 63, y: 12, firstSeen: 432, historicalDate: "1919–1929", description: "Moving images become a tightly controlled way for Soviet audiences to see the world." },
  { id: "poniatoff", label: "Alexander Poniatoff", kind: "person", image: "alexander-poniatoff.jpg", x: 87, y: 13, firstSeen: 660, historicalDate: "1892–1980", description: "The Russian-born electrical engineer and pilot who founded Ampex in California." },
  { id: "ampex", label: "Ampex videotape", kind: "object", image: "ampex-videotape.jpg", x: 24, y: 37, firstSeen: 817, historicalDate: "1944–1956", description: "Poniatoff’s company advances magnetic recording and demonstrates practical broadcast videotape." },
  { id: "kendall", label: "Donald Kendall", kind: "person", image: "donald-kendall.jpg", x: 50, y: 36, firstSeen: 1043, historicalDate: "1921–2020", description: "The ambitious Pepsi executive who turns the Moscow exhibition into an international opening." },
  { id: "pepsi", label: "Pepsi-Cola", kind: "object", image: "vintage-pepsi-cans.jpg", x: 76, y: 37, firstSeen: 0, historicalDate: "1893 onward", description: "A struggling soft drink that becomes both consumer product and instrument of exchange." },
  { id: "nixon", label: "Richard Nixon", kind: "person", image: "richard-nixon.jpg", x: 13, y: 62, firstSeen: 0, historicalDate: "1959", description: "The U.S. vice president who guides Khrushchev through the exhibition and into the televised debate." },
  { id: "exhibition", label: "American Exhibition", kind: "event", image: "kitchen-debate.jpg", x: 38, y: 62, firstSeen: 1357, historicalDate: "July 1959", description: "A six-week Moscow showcase where consumer goods become arguments about political systems." },
  { id: "khrushchev", label: "Nikita Khrushchev", kind: "person", image: "nikita-khrushchev.jpg", x: 63, y: 62, firstSeen: 0, historicalDate: "1953–1964", description: "The Soviet leader who samples Pepsi and debates Nixon inside the model kitchen." },
  { id: "vodka", label: "Stolichnaya", kind: "object", image: "stolichnaya.jpg", x: 87, y: 62, firstSeen: 18, historicalDate: "Soviet era", description: "State-produced vodka that later becomes Pepsi’s barter payment for entering the Soviet market." },
  { id: "fleet", label: "The Pepsi fleet", kind: "object", image: "pepsi-fleet.jpg", x: 35, y: 88, firstSeen: 2047, historicalDate: "1989", description: "Decommissioned Soviet submarines and ships included in a much larger barter agreement." },
  { id: "putin", label: "Vladimir Putin", kind: "person", image: "vladimir-putin.jpg", x: 66, y: 88, firstSeen: 2140, historicalDate: "1999 onward", description: "Dan’s final turn: renewed conflict and authoritarian rule constrict the cross-border opening." },
];
